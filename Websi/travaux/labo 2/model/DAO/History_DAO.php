...
class History_DAO
{
    ...
    public function setHistory(History_metier $hist)
    {
        $result = $this->pdo->prepare("INSERT INTO history (his_task_fk,his_description,his_comment,his_state,his_user_fk) VALUES (:a,:b,:c,:d,:e)");
        $result->execute(array(
            ":a" => $hist->getTask()->getId(),
            ":b" => $hist->getDescription(),
            ":c" => $hist->getCommentaire(),
            ":d" => $hist->getTask()->getState(),
            ":e" => $hist->getUser()->getIdentifiant()
