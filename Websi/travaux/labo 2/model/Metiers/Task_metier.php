...
class Task_metier extends Generic_metier
{
    ...
    public function __construct($id, $tache, $date, $catID)
    {
        ...
        $this->description = isset($this->history[0]) ? $this->history[0]->getDescription() : null;
    }
    ...
    {
        return $this->history[0]->getState();
    }

    public function save()
    {
        Application::getDAOFactory()->getTaskDao()->setTask($this);
    }
